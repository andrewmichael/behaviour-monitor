...
- [x] **Phase 20: Correlation Lifecycle** - Stale pair decay and cleanup on entity removal (completed 2026-04-07)
...
- [x] 20-02-PLAN.md — Coordinator wiring for entity removal cleanup on startup
